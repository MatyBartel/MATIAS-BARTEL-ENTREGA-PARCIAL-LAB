...
def agregar_producto(lista_diccionarios:list):
    ...
    id = input("Ingrese id del producto:")                            # ID
...
def guardar_json_csv(lista:list,direccion_archivo_nuevo,guardar_json_o_csv:True):
    """
